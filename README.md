[![MacOS](https://github.com/acgetchell/cdt/actions/workflows/macos.yml/badge.svg?branch=main)](https://github.com/acgetchell/cdt/actions/workflows/macos.yml)
[![Windows](https://github.com/acgetchell/cdt/actions/workflows/windows.yml/badge.svg)](https://github.com/acgetchell/cdt/actions/workflows/windows.yml)
[![Ubuntu](https://github.com/acgetchell/cdt/actions/workflows/ubuntu.yml/badge.svg)](https://github.com/acgetchell/cdt/actions/workflows/ubuntu.yml)
[![Style](https://github.com/acgetchell/cdt/actions/workflows/style.yml/badge.svg)](https://github.com/acgetchell/cdt/actions/workflows/style.yml)
[![Install](https://github.com/acgetchell/cdt/actions/workflows/install.yml/badge.svg)](https://github.com/acgetchell/cdt/actions/workflows/install.yml)
[![codecov](https://codecov.io/github/acgetchell/cdt/branch/main/graph/badge.svg?token=j6KLKrV8jT)](https://codecov.io/github/acgetchell/cdt)



# CDT

Generate spacetimes on your laptop
...
> I want to create additional targets that depend on my library. Should I modify the main CMakeLists to include them?
...
Depending on type it might make sense move these components into a separate repositories and reference a specific commit or version of the library.
...
- [CDT-plusplus](https://github.com/acgetchell/CDT-plusplus) - Original version of this project

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=acgetchell/CDT-plusplus&type=Date)](https://star-history.com/#acgetchell/CDT-plusplus&Date)
